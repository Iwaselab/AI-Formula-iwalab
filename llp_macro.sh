...
tmux send-keys -t $SESSION:1 "export PYTHONPATH=/home/fuga/workspace/ros2_ws_git/src/AI-Formula-iwalab/perception/yolop:\$PYTHONPATH" C-m
tmux send-keys -t $SESSION:1 "export PYTHONPATH=/home/fuga/workspace/ros2_ws_git/src/AI-Formula-iwalab/perception/yolop/yolop:\$PYTHONPATH" C-m
