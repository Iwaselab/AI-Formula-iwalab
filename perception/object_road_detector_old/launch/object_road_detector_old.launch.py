...
def generate_launch_description():
    PACKAGE_NAME = "object_road_detector_old"
    _, TOPIC_NAMES = get_frame_ids_and_topic_names()
    ROS_PARAM_CONFIG = (
        osp.join(get_package_share_directory(PACKAGE_NAME), "config", "object_road_detector_old.yaml"),
    )
    ...
    launch_args = (
        DeclareLaunchArgument(
            ...
            default_value=osp.join(get_package_share_directory(
                "object_road_detector_old"), "weights", "epoch-600.pth"),
