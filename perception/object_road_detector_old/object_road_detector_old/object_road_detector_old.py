...
from .object_road_detector_old_util import to_rect, draw_lane_lines, draw_bounding_boxes


class ObjectRoadDetectorOld(Node):

    def __init__(self):
        super().__init__('object_road_detector_old')
...
def main(args=None):
    ...
    object_road_detector_old = ObjectRoadDetectorOld()
    try:
        rclpy.spin(object_road_detector_old)
    except KeyboardInterrupt:
        print('Caught KeyboardInterrupt (Ctrl+C), shutting down...')
    finally:
        object_road_detector_old.destroy_node()
